...
var yourName = readlineSync.question("Please enter your name : ");
...
function selectQuiz(){
  ...
  4) Captain America
  `);
  var quizSelection = readlineSync.question("Please select the number of the quiz you want to play : ");
...
function playAgain() {
  for(var i = 0 ; i < quizNumber.length ; i++){ 
